...
class DetalleBancario extends CI_Controller {
	...
	public function index(){
		$this->data['menu_superior'] = $this->load->view('menu_superior', array('breadcrumb' => 'Detalle bancario'), TRUE);
		$this->data['footer'] = $this->load->view('footer', '', TRUE);
		$this->template->content->view('detalle_bancario', $this->data);
