	...
	<div class="container-lg px-4">
	  ...
	  <div class="card mb-4">
		<div class="card-header">
		  <strong>Registro de viviendas</strong>
		</div>
		<div class="card-body">
		  <p class="text-body-secondary small">Información obtenida desde el excel</p>
		  <div class="d-flex justify-content-end">
			<a href="<?php echo site_url('viviendas/agregar') ?>" class="btn btn-success text-white">
				...
				<table class="table table-bordered table-hover" id='viviendas_table'>
				  <thead>
					<tr>
					  ...
					  <th scope="col">Marbetes autorizados</th>
					...
					<tr class="table-info">
					  ...
					  <td><?php echo $data->mz ?></td>
					  <td><?php echo $data->prototipo ?></td>
					  <td><?php echo $data->codigo_identificador ?></td>
					  <td><?php echo $data->numero_marbetes_autorizados ?></td>
					  ...
					  <td>
						<ul class="list-group list-group-horizontal">
						  <li class="list-group-item" style="border: none !important;background-color: transparent!important;">
							<a class="btn btn-warning" href='<?php echo site_url("viviendas/editar/$data->id") ?>'>
...
$('#btnConfirmarEliminar').on('click', function () {
  ...
  $.ajax({
	url: "<?php echo site_url('viviendas/eliminar/') ?>" + idRegistro, // Ajusta la ruta a tu proyecto
