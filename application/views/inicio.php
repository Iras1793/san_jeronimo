...
<div class="wrapper d-flex flex-column min-vh-100">
	...
	<header class="header header-sticky p-0 mb-4">
		<div class="container-fluid border-bottom px-4">
			...
			<ul class="header-nav ms-auto">
				<li class="nav-item"> <!-- Logo de notificación-->
				...
				<li class="nav-item dropdown">
					<a class="nav-link py-0 pe-0" data-coreui-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
						<div class="avatar avatar-md">
							...
							<path d="M16.0834 6.9375C16.0834 9.11212 14.2552 10.875 12.0001 10.875C9.74492 10.875 7.91675 9.11212 7.91675 6.9375C7.91675 4.76288 9.74492 3 12.0001 3C14.2552 3 16.0834 4.76288 16.0834 6.9375Z" stroke="#0095FF" stroke-width="1.5"/>
							</svg>
							<!--<img class="avatar-img" src="assets/img/avatars/8.jpg" alt="user@email.com">-->
						</div>
			  		</a>
					<div class="dropdown-menu dropdown-menu-end pt-0">
						<div class="dropdown-header bg-body-tertiary text-body-secondary fw-semibold rounded-top mb-2">Notas</div>
						...
						<div class="dropdown-header bg-body-tertiary text-body-secondary fw-semibold my-2">
				  		<div class="fw-semibold">Detalles</div>
					</div>
		...
		<div class="container-fluid px-4">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb my-0">
					<li class="breadcrumb-item active"><span><?php echo $breadcrumb ?></span></li>
				</ol>
			</nav>
		</div>
	...
	<div class="body flex-grow-1">
		<div class="container-lg px-4"></div>
	</div>
	<footer class="footer px-4">
		<div class="ms-auto">Creado por <a href="https://irasdargor.com.mx/">Iras Dargor</a></div>
	</footer>
</div>