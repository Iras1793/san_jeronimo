...
<div class="card mb-4">
            <div class="card-header">
              <strong>Catálogo de multas</strong>
            </div>
            <div class="card-body">
              <p class="text-body-secondary small">Información obtenida desde el excel</p>
              <div class="d-flex justify-content-end">
              <a href="<?php echo site_url('multas/agregar') ?>" class="btn btn-success text-white">
              ...
              <div class="example">
                ...
                <div class="tab-content rounded-bottom">
                  <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1001">
                    <table class="table table-bordered table-hover" id='multas_table'>
                      <thead>
                        <tr>
                          <th scope="col">#</th>
                          ...
                          <th scope="col">Reincidencia 1</th>
                          <th scope="col">Reincidencia 2</th>
