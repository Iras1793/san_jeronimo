		...
		<div class="container-lg px-4">
			...
			<div class="card-body">
				...
				<div class="d-flex justify-content-end">
					<a href="<?php echo site_url('proveedores/agregar') ?>" class="btn btn-success text-white">
				...
				<div class="example">
					...
					<div class="tab-content rounded-bottom">
						<div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1001">
							<table class="table table-bordered table-hover" id='proveedores_table'>
								<thead>
									<tr>
										<th scope="col">#</th>
								...
								<tbody>
									...
									<tr class="table-info">
										...
										<td><?php echo $data->direccion_fisica ?></td>
										<td><?php echo $data->telefono_1 ?></td>
										<td><?php echo $data->telefono_2 ?></td>
										<td><?php echo $data->email ?></td>
										<td><?php echo $data->sitio_web ?></td>
										<td>
											<ul class="list-group list-group-horizontal">
												<li class="list-group-item" style="border: none !important;background-color: transparent!important;">
													<a class="btn btn-warning" href='<?php echo site_url("proveedores/editar/$data->id") ?>'>
...
$('#btnConfirmarEliminar').on('click', function () {
  ...
  $.ajax({
	url: "<?php echo site_url('proveedores/eliminar/') ?>" + idRegistro, // Ajusta la ruta a tu proyecto
