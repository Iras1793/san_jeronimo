...
<div class="card mb-4">
            ...
            <div class="card-body">
              ...
              <a href="<?php echo site_url('sanciones/agregar') ?>" class="btn btn-success text-white">
              ...
              <div class="example">
                ...
                <div class="tab-content rounded-bottom">
                  <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1001">
                    <table class="table table-bordered table-hover" id='sanciones_table'>
                      <thead>
                        <tr>
                          <th scope="col">#</th>
