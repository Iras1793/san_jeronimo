							...
							<table class="table table-bordered table-hover" id='viviendas_table'>
								...
								<tbody>
									...
									<tr class="table-info">
										...
										<td>
											<?php if($data->tipo=='PeatonalPulsera'): ?>
												Peatonal - Pulsera
											<?php elseif($data->tipo=='PeatonalLlavero'): ?>
												Peatonal - Llavero
											<?php else: ?>
												<?php echo $data->tipo ?>
											<?php endif; ?>
										</td>
										<td><?php echo $data->calle . ' ' . $data->numero ?></td>
										<td><?php echo $data->fecha_asignacion ?></td>
										<td><?php echo $data->fecha_activacion ?></td>
										<td>
											<?php if($data->activado==1): ?>
												Sí
											<?php elseif($data->activado==2): ?>
												No
											<?php else: ?>
												Inhabilitado
											<?php endif; ?>
